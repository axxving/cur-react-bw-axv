...
export const App = () => {
  ...
  return (
    <div className="min-h-screen dark:bg-gray-900 bg-gray-300 bg-[url('./assets/imgs/bg-mobile-light.jpg')] bg-contain bg-no-repeat dark:bg-[url('./assets/imgs/bg-mobile-dark.jpg')]">
      <Header />
